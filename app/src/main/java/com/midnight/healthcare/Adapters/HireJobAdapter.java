...
import com.midnight.healthcare.Activity.JobSummaryActivity;
 ...
 */
public class HireJobAdapter extends BaseAdapter {
    ...
    public HireJobAdapter(List<Jobs> list, Context context , Nurse nurse) {
        this.list = list;
...
//        RATING
        ...
        rating.setText("RATING: " + String.valueOf(TextUtils.rand()));
